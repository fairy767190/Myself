...
public class Demo05File {
    ...
    private static void show02() {
        File f1 = new File("vvv");
        boolean b1 = f1.mkdir();
        System.out.println("b1:"+b1);
       // D:\BaiduYunDownload\00 讲义+笔记+资料\1.Java基础\08.File类与IO流\19.【File类、递归】-笔记\code\08_FileAndRecursion
        File f2 = new File("08_FileAndRecursion\\111\\222\\333\\4444");
